...
#Logging starten
Version = "V1.0"
logging.basicConfig(filename='/home/pi/Alfred/Logs/Alf_Motor.log',level=logging.DEBUG ,format='%(asctime)s %(message)s', datefmt='%m/%d/%Y %I:%M:%S %p')
logging.debug("----------- Starte Alfred Modul - Motorsteuerung {0} ---------------".format(Version))
