...
def main():
    ...
    Button(root, text="Forwaerts", width=10, height=2, command= lambda: engin.move(1,1,100,100) .grid(row=9, column=1, padx=5, pady=5, rowspan=1)
    Button(root, text="Drehen", width=10, height=2, command= lambda: engin.move(1,2,50,50) .grid(row=9, column=1, padx=5, pady=5, rowspan=1)
