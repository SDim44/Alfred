...
def main():
    ...
    Button(root, text="Forwaerts", width=5, height=2, command= lambda: engin.move(1,1,100,100)) .grid(row=10, column=1, padx=0, pady=5, rowspan=2)
    Button(root, text="Drehen", width=5, height=2, command= lambda: engin.move(1,2,50,50)) .grid(row=10, column=1, padx=10, pady=5, rowspan=2)
